...
public class PaypalApi {
	...
	public ResponseEntity<String> payment(@RequestBody PaypalCheckoutRequest req ) {
		try {
			...
			Payment payment = service.createPayment(req.getAmount(), "USD", req.getPaymentMethod(), "sale", "Buy a journal","http://localhost:8080/"+CANCEL_URL, "http://localhost:8080/"+SUCCESS_URL);
